...
import { BirthdayWidgetProps, BirthdayWidget } from "./birthday-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <birthday-widget message="world!"></birthday-widget>
   */
  return class BirthdayWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): BirthdayWidgetProps {
      const attrs = this.parseAttributes<BirthdayWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<BirthdayWidget {...this.props} />, container);
    }
